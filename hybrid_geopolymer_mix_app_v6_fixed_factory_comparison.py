...
st.markdown("Enter actual factory weights (default = same as lab mix):")
...
with col2:
    ...
    m_water_f = st.number_input("Extra added water (g)", value=round(m_water_extra, 2))
...
mol_Na2O_Sil_f = (m_silicate_f * 0.335 * MW["Na2O"]) / (MW["SiO2"] * 3.3 + MW["Na2O"])
mol_SiO2_Sil_f = (m_silicate_f * 0.335 * MW["SiO2"] * 3.3) / (MW["SiO2"] * 3.3 + MW["Na2O"])
...
st.header("4. Comparison: Lab vs Factory")
