...
# Compute factory oxide moles
mol_GGBS_f = oxide_mol(m_ggbs, ggbs)
mol_MK_f = oxide_mol(m_metapor_f, metapor)

mol_Si_f = mol_GGBS_f['Si'] + mol_MK_f['Si'] + ((m_silicate_f * 0.335 * 0.767) / MW["SiO2"])
mol_Al_f = mol_GGBS_f['Al'] + mol_MK_f['Al']
mol_Ca_f = mol_GGBS_f['Ca']
mol_Na2O_f = mol_GGBS_f['Na2O'] + ((m_naoh_f * 0.5) / MW["NaOH"]) / 2 + ((m_silicate_f * 0.335 * 0.233) / MW["Na2O"])
